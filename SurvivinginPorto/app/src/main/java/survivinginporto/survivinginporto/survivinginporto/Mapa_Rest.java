...
public class Mapa_Rest extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(survivinginporto.survivinginporto.survivinginporto.R.layout.activity_mapa__rest);
    ...
    class MarkerBD
    {
        ...
        public void marcadoresMapa() {
            try {
                ...
                String restauracao = stringBuilder.toString().trim();


                JSONObject jsonObject = null;
                try {
                    jsonObject = new JSONObject(restauracao);
                } catch (JSONException e) {
                    e.printStackTrace();
                }
                JSONArray jsonArray = null;
                try {
                    jsonArray = jsonObject.getJSONArray("restauracao");
                } catch (JSONException e) {
                    e.printStackTrace();
                }
