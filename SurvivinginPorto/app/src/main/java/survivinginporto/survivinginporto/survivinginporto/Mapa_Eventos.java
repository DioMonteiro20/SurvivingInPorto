...
public class Mapa_Eventos extends FragmentActivity implements OnMapReadyCallback {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(survivinginporto.survivinginporto.survivinginporto.R.layout.mapa_eventos);
        ...
        class MarkerBD8 //extends AsyncTask<Void,Void,String>
        {
            ...
            public void marcadoresMapa() {
                try {
                    ...
                    String eventos = stringBuilder.toString().trim();



                    JSONObject jsonObject = null;
                    try {
                        jsonObject = new JSONObject(eventos);
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        String descricao1 = data+" às "+hora+" Entrada: "+custo+"€";
